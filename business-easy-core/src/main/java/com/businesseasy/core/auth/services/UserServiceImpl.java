package com.businesseasy.core.auth.services;

import com.businesseasy.core.auth.model.Role;
import com.businesseasy.core.auth.model.User;
import com.businesseasy.core.auth.repositories.RoleRepository;
import com.businesseasy.core.auth.repositories.UserRepository;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(user == null) {
            ...
            throw new InvalidRequestException(ReasonCode.USER_NOT_FOUND.getMessage());
        } else {
