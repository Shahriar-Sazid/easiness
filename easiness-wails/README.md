...
├── build/                  # Build artifacts and app icons
│   └── windows/
├── internal/
│   ├── db/
│   │   ├── database.go     # GORM + SQLite init + AutoMigrate
│   │   └── seed.go         # Seed initial data (units, conversions)
│   ├── models/             # GORM entity structs (11 files)
│   ├── dto/                # Request/response types (10 files)
│   └── service/            # Business logic (10 service files)
├── tests/
...
└── frontend/
    ...
    │   ├── main.ts
    │   ├── stores/          # Svelte writable stores (auth, data)
    │   ├── types/           # TypeScript interfaces
    │   ├── lib/             # Format utilities (replaces Angular pipes)
    │   ├── components/
    │   │   └── shared/      # Datatable, Modal, Pagination, Toast, etc.
    │   ├── routes/
    │   │   ├── dashboard/
    │   │   ├── product/
    │   │   ├── people/
